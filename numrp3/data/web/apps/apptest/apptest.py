...
routes = {}
routes['/apptest/xsendfile'] = xsendfile
routes['/apptest/logo'] = serve_logo
routes['/apptest/config'] = serve_config
...
def application(env, start_response):
    ...
    body = """
<img src="/apptest/logo"/> version {version}<br/>
<hr size="1"/>

Configuration<br/>
<iframe src="/apptest/config"></iframe><br/>
