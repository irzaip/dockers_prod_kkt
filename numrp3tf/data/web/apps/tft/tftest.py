...
routes = {}
routes['/tftest/xsendfile'] = xsendfile
routes['/tftest/logo'] = serve_logo
routes['/tftest/config'] = serve_config
...
def application(env, start_response):
    ...
    body = """
<img src="/tftest/logo"/> version {version}<br/>
<hr size="1"/>

Configuration<br/>
<iframe src="/tftest/config"></iframe><br/>
